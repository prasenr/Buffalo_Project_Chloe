//
//  NSObject+GooglePlusAccountHistoryModel.m
...
@implementation GooglePlusAccountHistoryModel : MTLModel
...
+ (NSValueTransformer *)accountJSONTransformer {
    ...
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[GooglePlusAccountModel class]];
}
