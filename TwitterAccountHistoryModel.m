//
//  NSObject+TwitterAccountHistoryModel.m
...
@implementation TwitterAccountHistoryModel : MTLModel
...
+ (NSValueTransformer *)accountJSONTransformer {
    ...
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[TwitterAccountModel class]];
}
