//
//  NSObject+PhoneNumberHistoryModel.m
...
@implementation PhoneNumberHistoryModel : MTLModel
...
+ (NSValueTransformer *)accountJSONTransformer {
    ...
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[PhoneNumberModel class]];
}
