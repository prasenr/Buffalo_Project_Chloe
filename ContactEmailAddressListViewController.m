//
//  ContactEmailAddressListViewController.m
...
@interface ContactEmailAddressListViewController ()
...
@implementation ContactEmailAddressListViewController
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EmailAddressHistoryModel *aAccountHistory = [self.person.emailAddresses objectAtIndex:indexPath.row];
    EmailAddressModel *aAccountModel = aAccountHistory.account;
    ...
    self.accountLabel.text = aAccountModel.emailAddress;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    headerLabel.text = @"Email Addresses";
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    EmailAddressModel *contactEmailAddressAccount = [self.person.emailAddresses objectAtIndex:indexPath.row];
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:contactEmailAddressAccount forKey:@"address"];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"showContactEmailAddressEditor" object:nil userInfo:userInfo];
...
-(void) createNoAccountsView {
    ...
    [addAccountButton setTitle:@"  add email address" forState:UIControlStateNormal];
...
-(IBAction)addAccountClicked:(id)sender {
    EmailAddressHistoryModel *contactEmailAddress = [[EmailAddressHistoryModel alloc] init];
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:contactEmailAddress forKey:@"emailAddress"];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"showContactEmailAddressEditor" object:nil userInfo:userInfo];
}

-(IBAction)onCancelClicked:(id)sender {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"cancelContactEmailAddressesList" object:nil];
}

-(void) addEmailAddress:(EmailAddressHistoryModel *)emailAddress {
    [self.person.emailAddresses addObject:emailAddress];
