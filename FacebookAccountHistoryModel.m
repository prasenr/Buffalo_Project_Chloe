//
//  NSObject+FacebookAccountHistoryModel.m
...
@implementation FacebookAccountHistoryModel : MTLModel
...
+ (NSValueTransformer *)accountJSONTransformer {
    ...
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[FacebookAccountModel class]];
}
