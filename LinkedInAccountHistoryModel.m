//
//  NSObject+LinkedInAccountHistoryModel.m
...
@implementation LinkedInAccountHistoryModel : MTLModel
...
+ (NSValueTransformer *)accountJSONTransformer {
    ...
    return [NSValueTransformer mtl_JSONDictionaryTransformerWithModelClass:[LinkedInAccountModel class]];
}
